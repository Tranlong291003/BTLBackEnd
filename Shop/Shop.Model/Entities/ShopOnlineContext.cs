...
namespace Shop.Model.Entities
{
    public partial class ShopOnlineContext : DbContext
    {
        ...
        public virtual DbSet<VisitorStaticti> VisitorStatictis { get; set; } = null!;
        public virtual DbSet<Customers> Customers { get; set; } = null!;
		public virtual DbSet<BookTour> BookTours { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=TRANKHANHLONG;Database=ShopOnline;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.DaySubmit).HasColumnType("datetime");
